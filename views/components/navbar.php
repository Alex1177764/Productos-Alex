        ...
        <div class="topbar-menu d-flex align-items-center gap-1">
            ...
            <div class="logo-box">
                ...
                <a href="index.html" class="logo-light">
                    <img src="./assets/imagenes/admired.png" alt="logo" class="logo-lg">
                    <img src="./assets/imagenes/admired.png" alt="small logo" class="logo-sm">
                </a>

                <!-- Brand Logo Dark -->
                <a href="index.html" class="logo-dark">
                    <img src="./assets/imagenes/admired.png" alt="dark logo" class="logo-lg">
                    <img src="./assets/imagenes/admired.png" alt="small logo" class="logo-sm">
                </a>
            </div>
        ...
        <ul class="topbar-menu d-flex align-items-center">
                        ...
                        <a href="javascript:void(0);"
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1 text-truncate ms-2">
                                        <h5 class="noti-item-title fw-semibold font-14"> Alex tovar <small
                        ...
                        <a href="javascript:void(0);"
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1 text-truncate ms-2">
                                        <h5 class="noti-item-title fw-semibold font-14">Alex Tovar</h5>
            ...
            <li class="dropdown">
                <a class="nav-link dropdown-toggle nav-user me-0 waves-effect waves-light" data-bs-toggle="dropdown"
                    href="#" role="button" aria-haspopup="false" aria-expanded="false">
                    <img src="./assets/imagenes/user.jpg" alt="user-image" class="rounded-circle">
                    <span class="ms-1 d-none d-md-inline-block">
                        Alex Tovar <i class="mdi mdi-chevron-down"></i>
                    </span>
                </a>
